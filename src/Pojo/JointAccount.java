...
public class JointAccount {
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : Constructor to initialize the JointAccount object with email, branch name, PAN card number, account number, PIN, and amount.
     ...
     *********************************************************
     */
    public JointAccount(String email, String branchName, String pancard, String accountNumber, Integer pin,
            Integer amount) {
        this.email = email;
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : Override of the toString method to provide a string representation of the JointAccount object, including email, branch name, PAN card, account number, PIN, and amount. 
