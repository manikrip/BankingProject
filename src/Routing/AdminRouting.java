...
public class AdminRouting {
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method routes the login request for the admin using the provided Employee object and database name.
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method routes the sign-in request for the admin using the provided Employee object, database name, and amount.
     * @param : emp (Employee) - The Employee object for the admin signing in.
     *          dbname (String) - The name of the database to be accessed.
     *          amount (Integer) - The amount related to the sign-in process.
     * @return : void
     *********************************************************
     */
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method routes the request to create a manager email view using the database name and amount provided.
     * @param : dbname (String) - The name of the database to be accessed.
     *          amount (Integer) - The amount related to the manager view creation.
     * @return : void
     *********************************************************
     */
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method routes the request to create a branch view using the database name and amount provided.
     * @param : dbname (String) - The name of the database to be accessed.
     *          amount (Integer) - The amount related to the branch view creation.
     * @return : void
     *********************************************************
     */
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method routes the request to create a cashier email view using the database name and amount provided.
     * @param : dbname (String) - The name of the database to be accessed.
     *          amount (Integer) - The amount related to the cashier view creation.
     * @return : void
     *********************************************************
     */
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method routes the request to send manager email using the provided Employee object, database name, and amount.
     * @param : emp (Employee) - The Employee object for the manager.
     *          dbname (String) - The name of the database to be accessed.
     *          amount (Integer) - The amount related to the manager email process.
     * @return : void
     *********************************************************
     */
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method routes the request to create a branch using the provided Branch object, database name, and amount.
     * @param : br (Branch) - The Branch object containing branch details.
     *          dbname (String) - The name of the database to be accessed.
     *          amount (Integer) - The amount related to the branch creation.
     * @return : void
     *********************************************************
     */
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method routes the request to send cashier email using the provided Employee object, database name, and amount.
     * @param : emp (Employee) - The Employee object for the cashier.
     *          dbname (String) - The name of the database to be accessed.
     *          amount (Integer) - The amount related to the cashier email process.
     * @return : void
     *********************************************************
     */
