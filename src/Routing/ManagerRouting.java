 ...
 */
 ...
 import Pojo.Loan;
 import controller.ManagaerController;
 ...
 *********************************************************
  ...
  *  @param          :   amountvalid (Integer) - A valid amount associated with the operation.
  *  @return         :   void
  *********************************************************
  */
 public static void usernameexit(Employee emp, String databaseName, Integer amountvalid) throws Exception {
     try {
         ManagaerController.userexit(emp, databaseName, amountvalid);
     } catch (Exception e) {
         throw e;
     }
 }
 ...
 *********************************************************
 ...
 public static void usernamenotexit(Employee emp, String databaseName, Integer amountvalid) throws Exception {
     try {
         ManagaerController.usernotexit(emp, databaseName, amountvalid);
     } catch (Exception e) {
         throw e;
     }
 }
 ...
 *********************************************************
  ...
  *  @param          :   databaseName (String) - The name of the database.
  *  @param          :   amountvalid (Integer) - A valid amount associated with the operation.
  *  @param          :   customer (Customer) - The customer object containing details.
  *  @return         :   void
  *********************************************************
  */
 public static void createSAccount(String databaseName, Integer amountvalid, Customer customer) throws Exception {
     try {
         ManagaerController.createSAccount(databaseName, amountvalid, customer);
     } catch (Exception e) {
         throw e;
     }
 }
 ...
 *********************************************************
  ...
  *  @param          :   databaseName (String) - The name of the database.
  *  @param          :   amountvalid (Integer) - A valid amount associated with the operation.
  *  @param          :   jointAccount (JointAccount) - The joint account object containing details.
  *  @param          :   validpancard1 (String) - The valid PAN card number for the first account holder.
  *  @param          :   name (String) - The name of the first account holder.
  *  @param          :   name1 (String) - The name of the second account holder.
  *  @return         :   void
  *********************************************************
  */
 public static void createJAccount(String databaseName, Integer amountvalid, JointAccount jointAccount,
     ...
     try {
         ManagaerController.createJAccount(databaseName, amountvalid, jointAccount, validpancard1, name, name1);
     } catch (Exception e) {
         throw e;
     }
 }
 ...
 *********************************************************
 ...
 public static void updationPancard(String databaseName, Integer amountvalid, Customer customer) throws Exception {
     try {
         ManagaerController.updationPancard(databaseName, amountvalid, customer);
     } catch (Exception e) {
         throw e;
     }
 }
 ...
 *********************************************************
  ...
  *  @param          :   databaseName (String) - The name of the database.
  *  @param          :   amountvalid (Integer) - A valid amount associated with the operation.
  *  @param          :   pancard (String) - The PAN card number of the account to be soft deleted.
  *  @return         :   void
  *********************************************************
  */
 public static void softDelete(String databaseName, Integer amountvalid, String pancard) throws Exception {
     try {
         ManagaerController.softDelete(databaseName, amountvalid, pancard);
     } catch (Exception e) {
         throw e;
     }
 }
 ...
 *********************************************************
  ...
  *  @param          :   databaseName (String) - The name of the database.
  *  @param          :   amountvalid (Integer) - A valid amount associated with the operation.
  *  @param          :   loan (Loan) - The loan object containing details.
  *  @return         :   void
  *********************************************************
  */
 public static void approvedLoan(String databaseName, Integer amountvalid, Loan loan) throws Exception {
     try {
         ManagaerController.approvedLoan(databaseName, amountvalid, loan);
     } catch (Exception e) {
         throw e;
     }
 }
 ...
 *********************************************************
 ...
 public static void CustomerInformationprint(String databaseName, Integer amountvalid, String pancard) throws Exception {
     try {
         ManagaerController.CustomerInformationprint(databaseName, amountvalid, pancard);
     } catch (Exception e) {
         throw e;
     }
 }
 ...
 *********************************************************
  ...
  *  @param          :   databaseName (String) - The name of the database.
  *  @param          :   amountvalid (Integer) - A valid amount associated with the operation.
  *  @param          :   validAccountnumber (String) - The account number to undo the transaction for.
  *  @return         :   void
  *********************************************************
  */
 public static void undoLastTransactioncustomer(String databaseName, Integer amountvalid, String validAccountnumber) throws Exception {
     try {
         ManagaerController.undoLastTransactioncustomer(databaseName, amountvalid, validAccountnumber);
     } catch (Exception e) {
         throw e;
     }
 }
