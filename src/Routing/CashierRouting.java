 ...
 *********************************************************
  ...
  *                      Employee object, database name, and valid amount.
 ...
 *********************************************************
  ...
  *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
  *  @Company        :   Antrazal
  *  @Description    :   This method handles the deposit operation for single accounts using the database name 
  *                      and valid amount provided.
  *  @param          :   databasename (String) - The name of the database to be accessed.
  *  @param          :   amountvalid (Integer) - The valid amount for the deposit operation.
  *  @return         :   void
  *********************************************************
  */
 ...
 *********************************************************
  ...
  *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
  *  @Company        :   Antrazal
  *  @Description    :   This method handles the deposit operation for joint accounts using the database name 
  *                      and valid amount provided.
  *  @param          :   databasename (String) - The name of the database to be accessed.
  *  @param          :   amountvalid (Integer) - The valid amount for the deposit operation.
  *  @return         :   void
 ...
 *********************************************************
  ...
  *  @param          :   databasename (String) - The name of the database to be accessed.
  *  @param          :   amountvalid (Integer) - The valid amount for the deposit operation.
  *  @param          :   trans (Transaction) - The Transaction object containing deposit details.
  *  @return         :   void
  *********************************************************
  */
 ...
 *********************************************************
  ...
  *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
  *  @Company        :   Antrazal
  *  @Description    :   This method handles the deposit operation for a specific joint account using the 
  *                      provided database name, valid amount, and transaction details.
  *  @param          :   databasename (String) - The name of the database to be accessed.
  *  @param          :   amountvalid (Integer) - The valid amount for the deposit operation.
  *  @param          :   trans (Transaction) - The Transaction object containing deposit details.
