 ...
 *********************************************************
  ...
  *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
  *  @Company        :   Antrazal
  *  @Description    :   This method routes to the customer view for sign-in and sign-up using the 
 ...
 *********************************************************
  ...
  *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
  *  @Company        :   Antrazal
  *  @Description    :   This method routes to the manager view for sign-in and sign-up using the 
  *                      provided database name and valid amount.
  *  @param          :   databaseName (String) - The name of the database to be accessed.
  *  @param          :   amountvalid (Integer) - The valid amount associated with the operation.
  *  @return         :   void
 ...
 *********************************************************
  ...
  *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
  *  @Company        :   Antrazal
  *  @Description    :   This method routes to the cashier view for sign-in and sign-up using the 
  *                      provided database name and valid amount.
  *  @param          :   databaseName (String) - The name of the database to be accessed.
  *  @param          :   amountvalid (Integer) - The valid amount associated with the operation.
  *  @return         :   void
 ...
 *********************************************************
  ...
  *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
  *  @Company        :   Antrazal
  *  @Description    :   This method routes to the admin view for sign-in using the provided database 
