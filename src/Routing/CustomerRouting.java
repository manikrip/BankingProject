 ...
 *********************************************************
  ...
  *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
  *  @Company        :   Antrazal
  *  @Description    :   This method checks if the username does not exist in the system using the provided 
  *                      Login object, database name, and amount.
  ...
  *  @param          :   amount (Integer) - The valid amount associated with the operation.
  *  @return         :   void
  *********************************************************
  */
 ...
 *********************************************************
  ...
  *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
  *  @Company        :   Antrazal
  *  @Description    :   This method checks if the username already exists in the system using the provided 
  *                      Login object, database name, and amount.
  *  @param          :   log (Login) - The Login object containing user login details.
  *  @param          :   dbname (String) - The name of the database to be accessed.
  *  @param          :   amount (Integer) - The valid amount associated with the operation.
 ...
 *********************************************************
  ...
  *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
  *  @Company        :   Antrazal
  *  @Description    :   This method initiates the process of creating a PIN for a single account using 
  *                      the provided database name and valid amount.
  *  @param          :   databasename (String) - The name of the database to be accessed.
  *  @param          :   amountvalid (Integer) - The valid amount associated with the operation.
  *  @return         :   void
  *********************************************************
  */
 ...
 *********************************************************
  ...
  *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
  *  @Company        :   Antrazal
  *  @Description    :   This method initiates the process of creating a PIN for a joint account using 
  *                      the provided database name and valid amount.
  *  @param          :   databasename (String) - The name of the database to be accessed.
  *  @param          :   amountvalid (Integer) - The valid amount associated with the operation.
  *  @return         :   void
 ...
 *********************************************************
  ...
  *  @param          :   databasename (String) - The name of the database to be accessed.
  *  @param          :   amountvalid (Integer) - The valid amount for the withdrawal operation.
  *  @return         :   void
  *********************************************************
  */
 ...
 *********************************************************
  ...
  *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
  *  @Company        :   Antrazal
  *  @Description    :   This method handles the withdrawal operation for a joint account using the 
  *                      provided database name and valid amount.
  *  @param          :   databasename (String) - The name of the database to be accessed.
  *  @param          :   amountvalid (Integer) - The valid amount for the withdrawal operation.
  *  @return         :   void
 ...
 *********************************************************
  ...
  *  @param          :   databasename (String) - The name of the database to be accessed.
  *  @param          :   amountvalid (Integer) - The valid amount associated with the loan request.
  *  @return         :   void
  *********************************************************
  */
 ...
 *********************************************************
  ...
  *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
  *  @Company        :   Antrazal
  *  @Description    :   This method prints the passbook for the customer using the provided database name 
  *                      and valid amount.
  *  @param          :   databasename (String) - The name of the database to be accessed.
  *  @param          :   amountvalid (Integer) - The valid amount for the operation.
  *  @return         :   void
  *********************************************************
  */
 ...
 *********************************************************
  ...
  *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
  *  @Company        :   Antrazal
  *  @Description    :   This method creates a PIN for a single account using the provided account number, 
  ...
  *  @param          :   validpin (Integer) - The valid PIN to be set.
  *  @param          :   databasename (String) - The name of the database to be accessed.
  *  @param          :   amountvalid (Integer) - The valid amount associated with the operation.
  *  @return         :   void
  *********************************************************
 ...
 *********************************************************
  ...
  *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
  *  @Company        :   Antrazal
  *  @Description    :   This method creates a PIN for a joint account using the provided account number, 
  *                      valid PIN, database name, and valid amount.
  *  @param          :   validAccountnumber (String) - The account number for which the PIN is to be created.
  *  @param          :   validpin (Integer) - The valid PIN to be set.
  *  @param          :   databasename (String) - The name of the database to be accessed.
 ...
 *********************************************************
  ...
  *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
  *  @Company        :   Antrazal
  *  @Description    :   This method handles the withdrawal operation for a single account using the provided 
  *                      account number, valid PIN, amount, database name, and valid amount.
  *  @param          :   validAccountnumber (String) - The account number from which to withdraw money.
  *  @param          :   validpin (Integer) - The valid PIN for account verification.
  *  @param          :   amount (Integer) - The amount to be withdrawn.
  *  @param          :   databasename (String) - The name of the database to be accessed.
  *  @param          :   amountvalid (Integer) - The valid amount associated with the operation.
  *  @return         :   void
  *********************************************************
 ...
 *********************************************************
  ...
  *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
  *  @Company        :   Antrazal
  *  @Description    :   This method handles the withdrawal operation for a joint account using the provided 
  *                      account number, valid PIN, amount, database name, and valid amount.
  *  @param          :   validAccountnumber (String) - The account number from which to withdraw money.
  *  @param          :   validpin (Integer) - The valid PIN for account verification.
  *  @param          :   amount (Integer) - The amount to be withdrawn.
 ...
 *********************************************************
  ...
  *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
  *  @Company        :   Antrazal
  *  @Description    :   This method initiates the loan creation process using the provided Loan object, 
  *                      database name, and valid amount.
 ...
 *********************************************************
  ...
  *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
  *  @Company        :   Antrazal
  *  @Description    :   This method prints the customer's passbook using the provided PAN number, database 
  *                      name, and valid amount.
