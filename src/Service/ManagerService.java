...
public class ManagerService {
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method creates a new manager if the manager doesn't already exist in the system.
     * @param : emp (Employee) - Manager employee object.
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method creates a single account for the given customer in the database.
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method creates a joint account for the given customers in the database.
     * @param : databaseName (String) - The name of the database.
     *          amountvalid (Integer) - Validation integer.
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method updates the PAN card number for the given customer in the database.
     * @param : databaseName (String) - The name of the database.
     *          amountvalid (Integer) - Validation integer.
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method soft deletes a customer account by activating a soft delete flag for the given PAN card.
     * @param : databaseName (String) - The name of the database.
     *          amountvalid (Integer) - Validation integer.
