...
public class Adminservice {
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method allows the admin to sign in by checking the username and password using the Admincheck repository.
     * @param : emp (Employee) - Employee object with admin credentials
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method is responsible for creating manager emails by calling the emailCreated method in the ManagerEmailInsert repository.
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method creates a new branch by calling the insert method in the BranchInsert repository.
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method is responsible for creating cashier emails by calling the emailCreated method in the CashierEmailInsert repository.
