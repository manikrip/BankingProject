...
public class DatabaseService {
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method handles the database creation and table creation operations. It calls methods from the Databaseinsert repository to insert a new database and create the required tables.
     * @param : dbname (String) - The name of the database to be created
     * @throws : Exception - Throws exception if the database creation or table
     * creation fails
     *********************************************************
     */
