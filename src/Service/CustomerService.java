...
public class CustomerService {
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method creates a new user if they don't exist by calling the usernamecreated method in the CustomerUserCreated repository.
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method creates a PIN for a single account by calling the insert method in the CustomerSinglePin repository.
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method creates a PIN for a joint account by calling the insert method in the CustomerJointPin repository.
     * @param : validAccountnumber (String) - Valid account number
     *           validpin (Integer) - Valid PIN to be created
     *           databasename (String) - Database name where the PIN will be created
     *           amountvalid (Integer) - Valid amount for validation
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method processes withdrawals for a single account by calling the withdraw method in the WithdrawSingle repository.
     * @param : validAccountnumber (String) - Valid account number
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method processes withdrawals for a joint account by calling the withdraw method in the WithdrawJoint repository.
     * @param : validAccountnumber (String) - Valid account number
     *           validpin (Integer) - Valid PIN for withdrawal
     *           amount (Integer) - Amount to be withdrawn
     *           databasename (String) - Database name where the transaction will occur
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method processes loan creation by calling the create method in the CustomerLoan repository.
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method prints the passbook for the customer by calling the printpassbookCustomer method in the GeneratingPassbook repository.
