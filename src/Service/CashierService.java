...
import Repository.CashierRepo.CashierUservalid;
 ...
 public class CashierService {
      ...
      *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
      *  @Company        :   Antrazal
      *  @Description    :   This method creates a new user if they do not exist by calling
      *                      the usernamecreated method in the CashierUserCreated repository.
      *  @param          :   emp (Employee) - Employee object for creating a new user
      *                      databaseName (String) - Database name where the user will be created
      *                      amountvalid (Integer) - Amount related to user creation
      ...
      *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
      *  @Company        :   Antrazal
      *  @Description    :   This method handles deposit transactions for a single account by
      *                      calling the insert method in the singleAccountDeposite repository.
      ...
      *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
      *  @Company        :   Antrazal
      *  @Description    :   This method handles deposit transactions for a joint account by
      *                      calling the insert method in the jointAccountDeposite repository.
      *  @param          :   databasename (String) - Database name where the transaction occurs
      *                      amountvalid (Integer) - Validated amount for the deposit
      *                      trans (Transaction) - Transaction object containing details of the deposit
      *  @throws         :   Exception - Throws exception if the deposit operation fails
