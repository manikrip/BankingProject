...
public class UpdateUsernamePassword {
     ...
     *                It checks how many rows were affected by the update query and proceeds to the home page if the update is successful.
     * @param : emp (Employee) - The Employee object containing the updated credentials.
     *          Database (String) - The name of the database to connect to.
     *          amount (Integer) - The amount related to the user session or transaction.
     ...
     * @Author : Manish Kripalani (manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method updates the username and password of a Login object in the database. Similar to the previous method, it verifies the success of the update and notifies the user accordingly.
