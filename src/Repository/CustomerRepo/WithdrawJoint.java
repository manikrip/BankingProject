...
import Utils.Constant;
 ...
 public class WithdrawJoint {
     ...
     *********************************************************
      ...
      *  @Author         :   Manish Kripalani (manish.kripalani@antrazal.com)
      *  @Company        :   Antrazal
      *  @Description    :   This method processes a withdrawal from a joint account. It checks the provided 
      ...
      *  @param          :   validpin (Integer) - The valid PIN for the joint account.
      ...
      *********************************************************
      */
     public static void withdraw(String validAccountnumber, Integer validpin, Integer amount, String databasename, Integer amountvalid) throws Exception, CustomException {
         try {
