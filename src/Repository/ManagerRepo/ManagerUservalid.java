...
import Utils.Constant;
 ...
 public class ManagerUservalid {
     ...
     *********************************************************
      ...
      *  @Author         :   Manish Kripalani (manish.kripalani@antrazal.com)
      *  @Company        :   Antrazal
      *  @Description    :   This method validates the user's email and designation. If valid, it proceeds to
      *                      verify the login process. If login is successful, it forwards to the manager 
      *                      functionality; otherwise, it throws an exception.
      ...
      *********************************************************
     */
     public static void uservalid(Employee emp, String databaseName, Integer amountvalid) throws Exception, CustomException {
