...
public class ManagerUserCreated {
     ...
     * @Author : Manish Kripalani (manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method validates the employee's email and designation. If the email is valid, it proceeds to update the username and password for the employee. If the email is invalid, a custom exception is thrown.
     ...
     *********************************************************
     */
    public static void usernamecreated(Employee emp, String databaseName, Integer amountvalid)
