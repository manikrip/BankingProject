...
public class CustomerInformationprint {
     ...
     * @Author : Manish Kripalani (manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : Retrieves customer information based on the provided Pan Card number.If found, the information is printed using the ManagerService.
     * @param : databaseName (String) - The name of the database to connect to.
     *          amountvalid (Integer) - The valid amount for the transaction.
     *          pancard (String) - The Pan Card number to search for.
     ...
     *********************************************************
     */
    public static void getInfo(String databaseName, Integer amountvalid, String pancard)
