...
public class ManagerUpdateAccount {
     ...
     * @Author : Manish Kripalani (manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method updates the account details of a customer in the database. It checks for the existence of the specified Pan Card number before updating the customer's name and email. If the update is successful, it notifies the user; otherwise, it throws a custom exception.
     ...
     *          customer (Customer) - The customer object containing updated details.
     ...
     *********************************************************
     */
    public static void update(String databaseName, Integer amountvalid, Customer customer)
