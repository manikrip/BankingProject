...
import Utils.Constant;
 ...
 public class ManagerJointAccount {
     ...
     *********************************************************
      ...
      *  @Author         :   Manish Kripalani (manish.kripalani@antrazal.com)
      *  @Company        :   Antrazal
      *  @Description    :   This method inserts a joint account into the database. It first checks if the branch 
      *                      exists and validates the provided PAN card numbers. It then generates a unique email 
      *                      for the joint account and inserts the data into the respective tables.
      ...
      *  @param          :   jointAccount (JointAccount) - The joint account object containing details for insertion.
      *  @param          :   validpancard1 (String) - The second PAN card number to be validated.
      *  @param          :   name (String) - The first name for creating an email address.
      *  @param          :   name1 (String) - The second part of the name for creating an email address.
