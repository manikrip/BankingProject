 ...
 */
 ...
 public class TransactionHistory {
     ...
     *********************************************************
      ...
      *                      It first checks if the PAN card exists, then fetches the corresponding account 
      *                      number, and finally retrieves the transaction history associated with that account.
      *  @param          :   dbname (String) - The name of the database to connect to.
      *  @param          :   amount (Integer) - The amount to filter the transactions (if applicable).
      *  @param          :   pancard (String) - The PAN card number for which the transaction history is 
      *                      being requested.
