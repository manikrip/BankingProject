...
public class loginProcess {
     ...
     * @Author : Manish Kripalani (manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method validates the login credentials of an Employee against the database.It returns true if the login is successful, otherwise false.
     ...
     * @Author : Manish Kripalani (manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method validates the login credentials of a user represented by the Login object against the database. It returns true if the login is successful, otherwise false.
