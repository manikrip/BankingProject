...
import Repository.DatabaseRepo.loginProcess;
 public class CashierUservalid {
     ...
     *********************************************************
      ...
      *  @Author         :   Manish Kripalani (manish.kripalani@antrazal.com)
      *  @Company        :   Antrazal
      *  @Description    :   Validates the cashier user by checking if the provided email exists for the 
      *                      specified designation. If valid, it verifies the password and proceeds to
      *                      the cashier's functionality.
