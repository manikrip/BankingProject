...
public class singleAccountDeposite {
     ...
     * @Author : Manish Kripalani (manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method processes a deposit transaction into a single account. It checks if the account exists, updates the balance after the deposit, and logs the transaction.
     * @param : databasename (String) - The name of the database to connect to.
     *          amountvalid (Integer) - The valid amount to be passed for further processing.
     *          trans (Transaction) - The Transaction object containing account details and amount.
     * @return : void
    ...
    public static void insert(String databasename, Integer amountvalid, Transaction trans)
        ...
        try {
            ...
            if (accountResultSet.next()) { // If account exists
                ...
                insertTransactionStatement.setTimestamp(4, java.sql.Timestamp.valueOf(LocalDateTime.now())); // Set
                                                                                                             // transaction
                                                                                                             // time
