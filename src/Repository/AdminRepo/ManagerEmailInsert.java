 ...
 */
 ...
 public class ManagerEmailInsert {
     ...
     *********************************************************
      ...
      *  @Author         :   Manish Kripalani (manish.kripalani@antrazal.com)
      *  @Company        :   Antrazal
      *  @Description    :   This method creates a new manager email entry in the database. It first checks if 
      *                      the branch exists and if a manager is already assigned. If all checks pass, it inserts 
      ...
      *  @param          :   dbname (String) - The name of the database where the entries will be made.
      *  @param          :   amount (Integer) - A parameter indicating a certain amount, potentially for validation.
