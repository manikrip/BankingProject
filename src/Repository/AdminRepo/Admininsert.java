...
import Utils.Constant;
 ...
 public class Admininsert {
     ...
     *********************************************************
      ...
      *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
      *  @Company        :   Antrazal
      *  @Description    :   Inserts a new admin's credentials and personal information into the database.
      *  @param          :   dbname (String) - The name of the database.
      *  @param          :   emp (Employee) - The employee object containing admin details.
      *  @return         :   void
