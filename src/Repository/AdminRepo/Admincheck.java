...
public class Admincheck {
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : Validates the admin login credentials by checking the provided email against the database. If valid, it initiates the login process.
     * @param : dbname (String) - The name of the database.
     *          emp (Employee) - The employee object containing admin login details.
     *          amount (Integer) - An amount associated with the admin functions.
     * @return : void
     * @throws : SQLException - If an SQL error occurs.
     * CustomException - If the login attempt fails.
     *********************************************************
     */
    public static void adminUsernamePassword(String dbname, Employee emp, Integer amount)
            throws SQLException, Exception, CustomException {
