...
public class CashierEmailInsert {
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : Creates a new cashier by inserting their details into the
     * database.
     ...
     *          amount (Integer) - An amount for admin operations.
     * @return : void
     * @throws : CustomException - If the branch does not exist, a cashier is
     * already assigned,
