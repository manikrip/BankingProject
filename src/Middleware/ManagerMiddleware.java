 ...
 *********************************************************************************************************/
 ...
 public class ManagerMiddleware {
     ...
     *********************************************************
      ...
      *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
      *  @Company        :   Antrazal
      *  @Description    :   Handles the exit of a manager by validating the provided email, username, 
     ...
     *********************************************************
      ...
      *  @Author         :   Manish Kripalani (Manish.kripalani@antrazal.com)
      *  @Company        :   Antrazal
      *  @Description    :   Handles the creation of a new manager by validating the provided details and
     ...
     *********************************************************
     ...
     public static void createJointAccount(String databaseName, Integer amountvalid, String branchName, String name,
         ...
         try {
             ...
             Integer validamount = ParamChecker.checkParameters(amount, amountvalid);
             String accountNumber = AccountNumber.generateRandomString();
             if (validpancard.equals(validpancard1)) {
                 throw new CustomException(Constant.PANCARDDIFFERENT);
             } else {
                 JointAccount jointAccount = new JointAccount(null, validbranchName, validpancard, accountNumber, null,
                         validamount);
                 ManagerRouting.createJAccount(databaseName, amountvalid, jointAccount, validpancard1, validname, validname1);
             }
         } catch (Exception e) {
             throw e;
         }
