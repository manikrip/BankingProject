...
public class CashierMiddleware extends BaseMiddleware {
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method validates cashier credentials (email, username, password) and routes them for login if valid.
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method handles the creation of a new cashier account by validating email, username, and password, and routes the data accordingly.
     * @param : email (String) - Cashier's email address
     *                           username (String) - Cashier's username
     *                           password (String) - Cashier's password
     *                           dbname (String) - Database name
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method allows the cashier to choose between different options such as creating a single or joint deposit account.
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method handles single account deposits by validating the account number and amount, and routing the transaction for further processing.
     * @param : databasename (String) - Database name
     *          amountvalid (Integer) - Validated amount
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method handles joint account deposits by validating the account number and amount, and routing the transaction for further processing.
     * @param : databasename (String) - Database name
     *          amountvalid (Integer) - Validated amount
     *          amount (Integer) - Deposit amount
     *          accountNumber (String) - Account number for deposit
