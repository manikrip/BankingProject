...
public class CustomerMiddleware extends BaseMiddleware {
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method validates customer credentials (email, username, password) and routes them for login if valid.
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method handles the creation of a new customer account by validating email, username, and password, and routes the data accordingly.
     * @param : email (String) - Customer's email address
     *          username (String) - Customer's username
     *          password (String) - Customer's password
     *          dbname (String) - Database name
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method allows the customer to choose between different actions such as creating a PIN, withdrawing money, or applying for a loan.
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method handles PIN creation for single accounts by validating the account number and PIN, then routes the data accordingly.
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method handles PIN creation for joint accounts by validating the account number and PIN, then routes the data accordingly.
     * @param : accountNumber (String) - Account number for PIN creation
     *                                   pin (Integer) - PIN to be set
     *                                   databasename (String) - Database name
     *                                   amountvalid (Integer) - Validated amount
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method handles single account withdrawals by validating the account number, PIN, and amount before routing the transaction for further processing.
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method handles joint account withdrawals by validating the account number, PIN, and amount before routing the transaction for further processing.
     * @param : accountNumber (String) - Account number for withdrawal
     *          pin (Integer) - PIN for authentication
     *          amount (Integer) - Amount to be withdrawn
     *          databasename (String) - Database name
     ...
     * @Author : Manish Kripalani (Manish.kripalani@antrazal.com)
     * @Company : Antrazal
     * @Description : This method processes loan requests by validating PAN number, loan number, and loan amount, then routes the loan request for further processing.
